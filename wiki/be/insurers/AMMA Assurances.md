...
country: be
insurer_slug: amma
name: AMMA Assurances
website: https://www.amma.be
products_count: 13
branches_covered:
- auto
- autres
...
**AMMA Assurances** - [https://www.amma.be](https://www.amma.be). 13 document(s) across 7 branch(es).
...
- Documents extraits des sources publiques listées dans `sources/be/amma.yml`.