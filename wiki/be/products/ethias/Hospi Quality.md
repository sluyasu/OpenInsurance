...
- Optionnelle : non · Portée : monde entier · Limite : jusqu'à concurrence du triple du montant de l'intervention légale
  - Sous-limite : {'name': 'Hospitalisation psychiatrique / psychogériatrique', 'limit': "période ou périodes d'hospitalisation cumulées ne dépassant pas 12 mois par assuré à compter du premier jour d'hospitalisation"}
