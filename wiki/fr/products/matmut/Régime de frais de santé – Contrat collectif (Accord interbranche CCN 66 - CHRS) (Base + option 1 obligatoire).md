...
- Optionnelle : non · Limite : 200% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 220% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 100% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 100% FR (base + option 1 obligatoire)
...
Prise en charge de l'intégralité du Forfait Patient Urgences (FPU) défini à l'article L. 160-13, I du Code de la Sécurité sociale.
- Optionnelle : non · Limite : 100% FR (base + option 1 obligatoire)
  - Sous-limite : Base + option 2 facultative : 100% FR
...
- Optionnelle : non · Limite : 100% FR (base + option 1 obligatoire)
  - Sous-limite : Conventionnée jour / nuit (avec nuitée) — base + option 1 obligatoire : limité à 2% PMSS ; base + option 2 facultative : limité à 3% PMSS
  - Sous-limite : Conventionnée de jour (sans nuitée) — base + option 1 obligatoire : limité à 1% du PMSS ; base + option 2 facultative : limité à 1,5% du PMSS
  - Sous-limite : Base + option 2 facultative : 100% FR

### Hospitalisation – Personne accompagnante - p. 23
Frais de séjour de la personne accompagnante.
- Optionnelle : non · Limite : 100% FR (base + option 1 obligatoire)
  - Sous-limite : Conventionné — base + option 1 obligatoire : limité à 1,5% PMSS / jour ; base + option 2 facultative : limité à 3% PMSS / jour
  - Sous-limite : Base + option 2 facultative : 100% FR
...
- Optionnelle : non · Limite : 200%BR (base + option 1 obligatoire, imprimé sans espace)
  - Sous-limite : Base + option 2 facultative : 200% BR
...
- Optionnelle : non · Limite : 170% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 150% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 150%BR (base + option 1 obligatoire, imprimé sans espace)
  - Sous-limite : Base + option 2 facultative : 170%BR
...
- Optionnelle : non · Limite : 130%BR (base + option 1 obligatoire, imprimé sans espace)
  - Sous-limite : Base + option 2 facultative : 150% BR
...
- Optionnelle : non · Limite : 25€/séance dans la limite de 4 séances par an/bénéficiaire (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 100% FR dans la limite des PLV (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 20% PMSS par oreille (au minimum 100% BR) (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : Base + option 1 obligatoire : Panier 100% santé 100% FR (dans la limite des HLF) ; Paniers maîtrisés (*) et libres 325% BR dans la limite de 1 050€ (hors RSS) par an et par bénéficiaire (au-delà, garantie à 125% BR)
...
- Optionnelle : non · Limite : 250% BR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : Base + option 1 obligatoire : Panier 100% santé néant ; Paniers maîtrisés et libres 100% BR
...
- Optionnelle : non · Limite : 300%BR (base + option 1 obligatoire)
  - Sous-limite : Base + option 2 facultative : 350% BR

### Dentaire – Orthodontie non remboursée Ss - p. 25
Orthodontie non remboursée par la Sécurité sociale.
- Optionnelle : non · Limite : 250% BRR (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 7% PMSS / an (base + option 1 obligatoire)
  - Sous-limite : Base + option 2 facultative : 10% PMSS / an

### Dentaire – Implantologie - p. 25
Implantologie.
- Optionnelle : non · Limite : 22% PMSS / an (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : Base + option 1 obligatoire : Équipements 100 % santé 100% FR dans la limite des PLV ; Équipements libres : Voir Grille Option 1
  - Sous-limite : Base + option 2 facultative : Équipements 100 % santé 100% FR dans la limite des PLV ; Équipements libres : Voir Grille Option 2
...
- Optionnelle : non · Limite : 100 % BR dans la limite des PLV (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 10 € par adaptation (minimum 100 % BR) dans la limite des PLV (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 3% PMSS par année civile, par bénéficiaire (au minimum 100 % BR pour les lentilles acceptées) (base + option 1 obligatoire)
...
- Optionnelle : non · Limite : 22% PMSS par année civile, par bénéficiaire (base + option 1 obligatoire)
...
- Optionnelle : oui · Limite : Niveaux définis en ANNEXE III (colonne BASE + OPTION 2 Facultative).
  ...
  - Condition : Les cotisations sont à votre charge exclusive, exprimées en pourcentage du Plafond Mensuel de la Sécurité sociale en vigueur au jour de leur exigibilité, et fixées par salarié isolé.
...
- COUCHE TEXTE — ce PDF utilise MASSIVEMENT les ligatures typographiques précomposées (U+FB01 fi, U+FB03 ffi, U+FB00 ff, U+FB04 ffl) : « bénéﬁcier », « déﬁnis », « aﬃliation », « eﬀet », « ﬁnancement », « justiﬁcatives ». Le même mot apparaît parfois sous les deux formes. Les key_quotes ont été découpées programmatiquement dans la couche texte et conservent ces caractères tels quels (par ex. « Votre employeur peut également mettre ﬁn au contrat en le signiﬁant »). Une citation retapée à la main ne s'apparierait pas au niveau des octets. À noter : la couverture (page 1) écrit « NOTICE D'INFORMATION » avec une apostrophe ASCII alors que le reste du document utilise l'apostrophe courbe U+2019.
...
- Source : [https://www.matmut.fr/pro/pdf/CCN-1966-notice-information-base-option-1.pdf](https://www.matmut.fr/pro/pdf/CCN-1966-notice-information-base-option-1.pdf) - téléchargé le 2026-07-30 - 32 pages
