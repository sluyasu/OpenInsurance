...
- Texte vérifié : les quotes sont des tranches exactes du texte ré-extrait du PDF local (PyMuPDF, page.get_text("text")), identique caractère pour caractère au texte du prompt une fois les marqueurs [page N] retirés. Particularités de la couche texte préservées telles quelles : 2 apostrophes typographiques U+2019, une espace insécable dans « 46 200 000 € », 5 tabulations dans les numéros de section (« 1.1\t », « 1.2.1\t »…), des guillemets courbes autour de “fonds actions” et “fonds immobilier”, et une espace finale après « un maximum de 30 € ». Aucun espace de largeur nulle, aucun tiret conditionnel, aucun glyphe de zone privée, aucune ligature perdue.
