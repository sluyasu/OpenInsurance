...
insurer_slug: gan
branch: prevoyance
product_name: Gan Patrimoine Protection Plus
document_type: ipid
...
target_audience_note: '« Ce produit d’assurance de groupe est destiné à garantir le
  ...
  ou d’entreprises.'
reference: GPP+01-122023 - PAO/GGVie
edition_date: '122023'
lang: fr
tags:
...
- insurer/gan
aliases:
- Gan Patrimoine Protection Plus
source_url: https://www.ganpatrimoine.fr/Media/documents/DIC/DIN%20PREV_Gan%20Patrimoine%20Protection%20Plus%20122023.pdf
source_pages: 2
fetched_at: '2026-07-30'
extraction_model: claude-code-subagent:scale
prompt_version: '1.1'
product_family: multirisques-prevoyance-individuelle
variant: Gan Patrimoine Protection Plus
...
- EDITION_DATE : aucune mention « édition MM/AAAA » imprimée. La date 122023 est lue dans le code d’impression de pied de page « GPP+01-122023 - PAO/GGVie » (reporté intégralement dans `reference`).
- SUPERSEDED : laissé à null. Ce document porte le code le plus récent (122023) parmi les IPID de ce produit traités dans ce lot ; l’édition 042022 du même produit est marquée superseded.
...
- PRODUCT_FAMILY : la ligne partagée imprimée en tête est « MULTIRISQUES PRÉVOYANCE INDIVIDUELLE », commune à cet IPID et à celui de « Gan Prévoyance Protection » (même code de date 122023). `product_family` reprend cette ligne partagée et `variant` le nom commercial de réseau imprimé après « Produit : ». Les tableaux CCSF du même produit (« Gan Patrimoine Protection Plus », 2025 et 2026) n’impriment pas cette ligne : ils ne peuvent donc pas porter la même valeur sans extrapolation.
...
- Source : [https://www.ganpatrimoine.fr/Media/documents/DIC/DIN%20PREV_Gan%20Patrimoine%20Protection%20Plus%20122023.pdf](https://www.ganpatrimoine.fr/Media/documents/DIC/DIN%20PREV_Gan%20Patrimoine%20Protection%20Plus%20122023.pdf) - téléchargé le 2026-07-30 - 2 pages
